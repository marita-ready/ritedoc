      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-3 text-white">ReadyCompliant</h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/" className="text-white/75 text-sm hover:text-white transition-colors">Home</Link>
              </li>
              <li>
                <Link href="/about" className="text-white/75 text-sm hover:text-white transition-colors">About</Link>
              </li>
              <li>
                <Link href="/ritedoc" className="text-white/75 text-sm hover:text-white transition-colors">RiteDoc</Link>
              </li>
              <li>
                <Link href="/contact" className="text-white/75 text-sm hover:text-white transition-colors">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link href="/privacy" className="text-white/75 text-sm hover:text-white transition-colors">Privacy Policy</Link>
              </li>
              <li>
                <Link href="/terms" className="text-white/75 text-sm hover:text-white transition-colors">Terms of Service</Link>
              </li>
            </ul>
          </div>
        </div>
